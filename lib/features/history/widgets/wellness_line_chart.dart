                ...
                child: Center(
                  child: sf.SfCartesianChart(
                    ...
                    primaryXAxis: sf.DateTimeAxis(
                      ...
                      axisLine: sf.AxisLine(color: Theme.of(context).textTheme.headline5!.color!.withOpacity(0.8), width: 0.5),
                      majorTickLines: sf.MajorTickLines(color: Theme.of(context).textTheme.headline5!.color!.withOpacity(0.8), width: 0.5),
